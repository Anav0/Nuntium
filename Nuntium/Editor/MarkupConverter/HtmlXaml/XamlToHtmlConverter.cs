...
namespace Nuntium
{
    ...
    /// <summary>
    /// XamlToHtmlConverter is a static class that takes an HTML string
    ...
    public static class XamlToHtmlConverter
    {
        ...
        public static string ConvertXamlToHtml(string xamlString, bool asFullDocument)
        {
            ...
            htmlStringBuilder = new StringBuilder(250);
        ...
        /// <summary>
        /// Reads several items from xamlReader skipping all insignificant stuff.
        /// </summary>
        /// <param name="xamlReader">
